...
//                } else if (taskType == 4 && requestParam.containsKey("breakId")) {
//                    Long breakId = Long.parseLong(requestParam.get("breakId"));
//                    WorkBreak workBreak = workBreakRepository.findByIdAndStatus(breakId, true);
//                    task.setWorkBreak(workBreak);
//                    task.setWorkDone(true);
//                } else {
...
////                        double pointPerJob = jobOperation.getPointPerJob();
//
...
//                                }
//                            } else {
//                                System.out.println("Job Operation data not exists ");
//                                responseMessage.setMessage("Job Operation data not exists to start task");
                ...
                if (taskList.size() > 0) {
                    for (TaskMaster task : taskList) {
                        ...
                        if(task.getTaskStatus().equalsIgnoreCase("in-progress"))
                            ...
                            jsonObject.addProperty("totalBreakTime", String.valueOf(task.getTotalTime()));
