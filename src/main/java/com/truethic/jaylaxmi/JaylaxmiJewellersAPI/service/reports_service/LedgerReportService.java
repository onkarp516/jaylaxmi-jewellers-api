package com.truethic.jaylaxmi.JaylaxmiJewellersAPI.service.reports_service;
...
import com.truethic.jaylaxmi.JaylaxmiJewellersAPI.repository.master_repo.FiscalYearRepository;
import com.truethic.jaylaxmi.JaylaxmiJewellersAPI.repository.tranx_repository.contra_repository.TranxContraDetailsRepository;
import com.truethic.jaylaxmi.JaylaxmiJewellersAPI.repository.tranx_repository.journal_repository.TranxJournalDetailsRepository;
...
//            }
            ...
            if (flag == true) {
                if (users.getSite() != null) {
                    mlist = transactionDetailsRepository.findByDetailsBetweenDates(users.getCompany().getId(), users.getSite().getId(), true, ledger_master_id, startDatep, endDatep);
...
//                branchId = users.getBranch().getId();
                ...
                if (users.getSite() != null) {
                    mlist = transactionDetailsRepository.findByDetailsBranch(users.getCompany().getId(), users.getSite().getId(), true, ledger_master_id);
        ...
        for (LedgerTransactionPostings ledgerTransactionDetails : mlist) {
            ...
            if (!ledgerTransactionDetails.getOperations().equalsIgnoreCase("Delete")) {
                ...
                if (tranx_type == 5) {
                    ...
                    if (users.getSite() != null) {
                        tranxReceiptPerticularsDetails = tranxReceiptPerticularsDetailsRepository.findByIdAndCompanyIdAndSiteIdAndStatus(ledgerTransactionDetails.getTransactionId(), users.getCompany().getId(), users.getSite().getId(), true);
                    } else {
                    ...
                    if (users.getSite() != null) {
                        tranxPaymentPerticulars = tranxPaymentPerticularsDetailsRepository.findByIdAndCompanyIdAndSiteIdAndStatus(ledgerTransactionDetails.getTransactionId(), users.getCompany().getId(), users.getSite().getId(), true);
                    } else {
                    ...
                    if (users.getSite() != null) {
                        tranxContraDetails = tranxContraDetailsRepository.findByIdAndCompanyIdAndSiteIdAndStatus(ledgerTransactionDetails.getTransactionId(), users.getCompany().getId(), users.getSite().getId(), true);
                    } else {
                    ...
                    if (users.getSite() != null) {
                        tranxJournalDetails = tranxJournalDetailsRepository.findByIdAndCompanyIdAndSiteIdAndStatus(ledgerTransactionDetails.getTransactionId(), users.getCompany().getId(), users.getCompany().getId(), true);
                    } else {
