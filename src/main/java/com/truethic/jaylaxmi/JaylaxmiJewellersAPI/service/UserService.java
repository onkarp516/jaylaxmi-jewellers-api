...
import com.truethic.jaylaxmi.JaylaxmiJewellersAPI.repository.access_permission_repository.SystemAccessPermissionsRepository;
import com.truethic.jaylaxmi.JaylaxmiJewellersAPI.repository.access_permission_repository.SystemActionMappingRepository;
import com.truethic.jaylaxmi.JaylaxmiJewellersAPI.repository.access_permission_repository.SystemMasterModuleRepository;
import com.truethic.jaylaxmi.JaylaxmiJewellersAPI.response.ResponseMessage;
import com.truethic.jaylaxmi.JaylaxmiJewellersAPI.common.CommonAccessPermissions;
import com.truethic.jaylaxmi.JaylaxmiJewellersAPI.common.PasswordEncoders;
import com.truethic.jaylaxmi.JaylaxmiJewellersAPI.dto.GenericDTData;
import com.truethic.jaylaxmi.JaylaxmiJewellersAPI.dto.UserDTDTO;
...
//    private OutletRepository outletRepository;
    ...
    public JsonObject addBoUserWithRoles(HttpServletRequest request) {
        ...
        try {
            ...
            Company company = companyRepository.findByIdAndStatus(Long.parseLong(request.getParameter("companyId")),true);users.setCompany(company);
            Site site = siteRepository.findByIdAndStatus(Long.parseLong(request.getParameter("siteId")),true);users.setSite(site);
...
//            }
    ...
    public Object changeAdminPassword(Map<String, String> request) {
        ResponseMessage responseMessage = new ResponseMessage();
        Users users = userRepository.findByUsernameAndStatus(request.get("username"), true);
        if (users != null) {
            users.setPlain_password(request.get("password"));
            String encPassword = passwordEncoder.encode(request.get("password"));
            users.setPassword(encPassword);
