...
import com.truethic.jaylaxmi.JaylaxmiJewellersAPI.dto.EmployeeDTO;
import com.truethic.jaylaxmi.JaylaxmiJewellersAPI.dto.EmployeeSalaryDTO;
...
//            employee.setEmployerEsi(Double.valueOf(request.getParameter("employerEsi")));
            ...
            try {
                ...
                try {
                    ...
                    mLedgerMaster.setSite(employee1.getSite());
                    ...
                    mLedgerMaster.setInstitute(employee1.getInstitute());
    ...
    private EmployeeEducation getEmployeeEducationFromJsonObject(JsonObject object, Users user) {
        ...
        employeeEducation.setYear(object.get("year").getAsString() != null ? Integer.parseInt(object.get("year").getAsString()): 0);
...
//            employee.setEmployerEsi(Double.valueOf(request.getParameter("employerEsi")));
    ...
    public Object addEmployeeDeviceId(Map<String, String> requestParam, HttpServletRequest request) {
        ResponseMessage responseMessage = new ResponseMessage();
        try {
...
//                employee.setPassword(encPassword);
    ...
    public Object createEmpLedgers(HttpServletRequest request) {
        ...
        try {
            ...
            try {
                List<Employee> employeeList = employeeRepository.findByInstituteIdAndStatus(users.getInstitute().getId(), true);
                ...
                for (Employee employee : employeeList) {
                    ...
                    mLedgerMaster.setFoundations(foundations);
                    mLedgerMaster.setPrincipleGroups(groups);
                    mLedgerMaster.setSite(employee.getSite());
                    ...
                    mLedgerMaster.setInstitute(employee.getInstitute());
                    LedgerMaster newLedger = ledgerMasterRepository.save(mLedgerMaster);
                }
        ...
        try {
            ...
            if(employeeList != null) {
                for (Employee employee : employeeList) {
                    ...
                    object.addProperty("site", employee.getSite().getSiteName());
                    jsonArray.add(object);
                }
                response.add("response", jsonArray);
                response.addProperty("responseStatus", HttpStatus.OK.value());
    ...
    public Object getEmployeePersonalInfo(Map<String, String> jsonRequest, HttpServletRequest request) {
        ...
        try {
            ...
            if(employee != null) {
                ...
                object.addProperty("address", employee.getAddress());
