...
import com.truethic.jaylaxmi.JaylaxmiJewellersAPI.repository.EmployeeLeaveRepository;
import com.truethic.jaylaxmi.JaylaxmiJewellersAPI.repository.LeaveTypeRepository;
import com.truethic.jaylaxmi.JaylaxmiJewellersAPI.response.ResponseMessage;
import com.truethic.jaylaxmi.JaylaxmiJewellersAPI.dto.EmployeeLeaveDTO;
...
import com.truethic.jaylaxmi.JaylaxmiJewellersAPI.model.LeaveType;
...
import com.truethic.jaylaxmi.JaylaxmiJewellersAPI.views.EmployeeLeaveView;
    ...
    public JsonObject getEmployeesLeaveRequests(HttpServletRequest request) {
        ...
        try{
            ...
            for(EmployeeLeave leave : leaveRequests){
                ...
                object.addProperty("designation",leave.getEmployee().getDesignation().getName());
                object.addProperty("leaveType",leave.getLeaveType().getName());
                object.addProperty("appliedOn",leave.getCreatedAt().format(DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm:ss")));
