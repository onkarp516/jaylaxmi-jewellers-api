...
public class LedgerCommonPostings {
    ...
    public void callToPostings(Double totalAmount, LedgerMaster ledgerMaster, TransactionTypeMaster tranxTypeMaster,
                               AssociateGroups associateGroups, FiscalYear fiscalYear, Site site, Company company,
        ...
        try {
            ...
            ledgerTransactionPostings.setSite(site);
...
//                openingStocks = inventoryDetailsPostingsRepository.findFiscalyearOpening(productId,outletId, branchId,fiscalYear.getId());
                if(branchId!=null) {
                    crOpening = ledgerMasterRepository.findLedgerOpeningStocksSite(ledgerId, outletId, branchId,"CR");
                    drOpening = ledgerMasterRepository.findLedgerOpeningStocksSite(ledgerId, outletId, branchId,"DR");
                    openingStocks= crOpening-drOpening;
                }
                else {
