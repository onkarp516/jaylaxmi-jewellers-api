...
public interface TranxReceiptPerticularsRepository extends JpaRepository<TranxReceiptPerticulars, Long> {
    ...
    TranxReceiptPerticulars findByIdAndCompanyIdAndSiteIdAndStatus(Long transactionId, Long id, Long id1, boolean b);

    TranxReceiptPerticulars findByIdAndCompanyIdAndStatus(Long transactionId, Long id, boolean b);

    TranxReceiptPerticulars findByTranxReceiptMasterIdAndCompanyIdAndSiteIdAndStatusAndType(Long transactionId, Long id, Long id1, boolean b, String cr);
