...
public interface TranxJournalDetailsRepository extends JpaRepository<TranxJournalDetails,Long> {
    ...
    TranxJournalDetails findByIdAndCompanyIdAndSiteIdAndStatus(Long tranx_type, Long id, Long id1, boolean b);
   ...
   List<TranxJournalDetails>  findByTranxJournalMasterIdAndTypeAndStatus(Long id, String dr, boolean b);
    ...
    TranxJournalDetails findByTranxJournalMasterIdAndCompanyIdAndSiteIdAndStatusAndType(Long transactionId, Long id, Long id1, boolean b, String dr);
