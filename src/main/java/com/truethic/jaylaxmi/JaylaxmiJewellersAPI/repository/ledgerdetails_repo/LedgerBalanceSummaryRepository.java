...
public interface LedgerBalanceSummaryRepository extends JpaRepository<LedgerBalanceSummary, Long> {
    ...
    List<LedgerBalanceSummary> findByCompanyIdAndSiteIdOrderByIdDesc(Long id, Long id1);

    List<LedgerBalanceSummary> findByCompanyIdAndSiteIdAndPrinciplesIdOrderByIdDesc(Long id, Long id1, long l);
