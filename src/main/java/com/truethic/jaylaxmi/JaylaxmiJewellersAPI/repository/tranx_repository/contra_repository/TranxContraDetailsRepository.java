...
*/
    ...
    TranxContraDetails findByIdAndCompanyIdAndSiteIdAndStatus(Long tranx_type, Long id, Long id1, boolean b);

    TranxContraDetails findByIdAndCompanyIdAndStatus(Long tranx_type, Long id, boolean b);

    TranxContraDetails findByTranxContraMasterIdAndCompanyIdAndSiteIdAndStatusAndType(Long transactionId, Long id, Long id1, boolean b, String dr);
