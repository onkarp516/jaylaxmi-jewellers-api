...
public interface LedgerTransactionPostingsRepository extends JpaRepository<LedgerTransactionPostings, Long> {
    ...
    @Query(
            value = "SELECT * FROM `ledger_transaction_postings_tbl` WHERE company_id=?1 AND site_id=?2 AND status=?3 AND " +
    ...
    @Query(
            value = "SELECT * FROM `ledger_transaction_postings_tbl` WHERE company_id=?1 AND site_id IS NULL AND status=?2 AND " +
    ...
    @Query(
            value = "SELECT IFNULL(SUM(amount),0.0) FROM `ledger_transaction_postings_tbl` LEFT JOIN " +
                    ...
                    "ledger_transaction_postings_tbl.company_id=1" + "AND ledger_transaction_details_tbl.site_id=?2 AND ledger_transaction_postings_tbl.status=?3 AND" +
    ...
    @Query(
            value = "SELECT SUM(amount),ledger_master_id ,ledger_type  FROM `ledger_transaction_postings_tbl` LEFT JOIN ledger_master_tbl ON " + " ledger_transaction_postings_tbl.ledger_master_id=ledger_master_tbl.id WHERE" + " ledger_transaction_postings_tbl.company_id=?1 AND" + " ledger_transaction_postings_tbl.site_id=?2 " +
    ...
    @Query(
            value = "SELECT IFNULL(SUM(amount),0),ledger_master_id,ledger_type FROM `ledger_transaction_postings_tbl` LEFT JOIN ledger_master_tbl ON " +
                    "ledger_transaction_postings_tbl.ledger_master_id=ledger_master_tbl.id WHERE " +
                    "ledger_transaction_postings_tbl.company_id=?1 AND ledger_transaction_postings_tbl.site_id=?2 ledger_transaction_postings_tbl.status=?3 AND " +
    ...
    @Query(
            value = "SELECT * FROM `ledger_transaction_postings_tbl` WHERE company_id=?1 AND (site_id=?2 OR site_id IS NULL) AND  status=?3 AND " +
    ...
    @Query(
            value = "SELECT IFNULL(SUM(amount),0.0),IFNULL(ledger_transaction_postings_tbl.principle_id,0) FROM `ledger_transaction_postings_tbl` LEFT JOIN ledger_master_tbl ON " +
                    ...
                    "AND ledger_transaction_postings_tbl.site_id=?2 AND ledger_transaction_postings_tbl.status=?3 AND ledger_master_tbl.principle_id=?4 AND " +
    ...
    @Query(
            value = "SELECT SUM(amount),principle_id  FROM `ledger_transaction_postings_tbl` WHERE ledger_transaction_postings_tbl.company_id=?1 AND ledger_transaction_postings_tbl.site_id=?2 " +
    ...
    @Query(
            value = " SELECT IFNULL(SUM(amount),0.0) FROM `ledger_transaction_postings_tbl` WHERE ledger_master_id=?1 AND " +
                    "company_id=?2 AND site_id=?3 AND " +
    ...
    @Query(
            value = " SELECT IFNULL(SUM(amount),0.0) FROM `ledger_transaction_postings_tbl` WHERE ledger_master_id=?1 AND " +
                    "company_id=?2 AND site_id IS NULL AND " +
    ...
    @Query(
            value = "SELECT COUNT(*) FROM `ledger_transaction_postings_tbl` WHERE  company_id=?1 AND site_id=?2 " +
    ...
    @Query(
            value = "SELECT IFNULL(SUM(amount),0.0) FROM `ledger_transaction_postings_tbl` WHERE company_id=?1 AND " +
                    "site_id=?2 AND transaction_date BETWEEN ?3 AND ?4 AND transaction_type_id=?5 AND " +
    ...
    @Query(
            value = "SELECT COUNT(*) FROM `ledger_transaction_postings_tbl` WHERE company_id=?1 AND " +
                    ...
                    "status=?5 AND site_id IS NULL AND ledger_type=?6", nativeQuery = true)
    ...
    @Query(
            value = "SELECT * FROM `ledger_transaction_postings_tbl` WHERE company_id=?1 AND site_id=?2 AND " +
    ...
    @Query(
            value = "SELECT * FROM `ledger_transaction_postings_tbl` WHERE company_id=?1 AND " +
                    ...
                    "AND site_id IS NULL ORDER by transaction_date",
            nativeQuery = true)
    ...
    @Query(
            value = "SELECT IFNULL(SUM(amount),0.0) FROM `ledger_transaction_postings_tbl` " +
                    ...
                    "ledger_transaction_postings_tbl.site_id=?3 AND ledger_transaction_postings_tbl.transaction_date " +
    ...
    @Query(
            value = "SELECT IFNULL(SUM(amount),0.0) FROM " +
                    ...
                    "ledger_transaction_postings_tbl.site_id IS NULL AND " +
