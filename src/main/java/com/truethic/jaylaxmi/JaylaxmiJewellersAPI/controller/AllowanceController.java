...
import com.truethic.jaylaxmi.JaylaxmiJewellersAPI.service.AllowanceService;
...
public class AllowanceController {
    ...
    @GetMapping(path="/get_allowance_list")
    public Object allowanceList(HttpServletRequest request){
        JsonObject object= allowanceService.allowanceList(request);
